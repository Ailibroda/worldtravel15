...
class Catalogo:
    ...
    def agregar_producto(self, descripcion, cantidad, precio, imagen, proveedor, destino, transporte):
        sql = "INSERT INTO productos (descripcion, cantidad, precio, imagen_url, proveedor, destino, transporte) VALUES (%s, %s, %s, %s, %s, %s, %s)"
    ...
    def modificar_producto(self, codigo, nueva_descripcion, nueva_cantidad, nuevo_precio, nueva_imagen, nuevo_proveedor, nuevo_destino, nuevo_transporte):
        sql = "UPDATE productos SET descripcion = %s, cantidad = %s, precio = %s, imagen_url = %s, proveedor = %s, destino = %s, transporte = %s WHERE codigo = %s"  ##
...
# Cuerpo del programa
#--------------------------------------------------------------------
# ip que dio el profe : 192.168.56.1
# Crear una instancia de la clase Catalogo   #192.168.100.7       # ACA AGREGO MI PASSWORD QUE ES elena
catalogo = Catalogo(host='192.168.100.7', user='root', password='elena', database='miapp')
